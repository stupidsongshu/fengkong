...
.controller('TabCtrl',function($scope,$rootScope,$ionicLoading,$timeout,$ionicHistory,$state){
    ...
    .controller('HomeCtrl',function($scope,$ionicLoading,$timeout,$ionicHistory, $state,$http,ApiEndpoint){
         ...
         function getBanner(){
        $http.post(ApiEndpoint.url+"banner/getBannerList.do",{},{params:{
            activated:2,
            type:1,
            pageNum:1,
            pageSize:10
...
.controller('ProgressCtrl',function($scope,$ionicLoading,$timeout,$ionicHistory, $state,$http,ApiEndpoint){
    ...
    $http.post(ApiEndpoint.url+"live/getLiveList.do",{},{params:{
        pageNum:1,
        pageSize:10
    }}).success(function(data){
        // console.log(data);
    ...
    $http.post(ApiEndpoint.url+"teacher/getTeacherList.do",{},{params:{
        pageNum:1,
        pageSize:10
    }}).success(function(data){
        if(data.errorCode == 0){
    ...
    $http.post(ApiEndpoint.url+"course/getCourseListForH5.do",{},{params:{
        pageNum:1,
        pageSize:10
    }}).success(function(data){
...
.controller('ProgressNewCtrl',function($scope,$http,ApiEndpoint){
    ...
    //直播
    $http.post(ApiEndpoint.url+"live/getAllLiveList.do",{},{params:{
        pageNum:1,
        pageSize:10,
    ...
    function getAllVideos(){
        $http.post(ApiEndpoint.url+"video/getAllNotCourseVideo.do",{},{params:{
            type:$scope.typeId,
            price:$scope.priceId
        }}).success(function(data){
            if(data.errorCode == 0){
    ...
    function courseFilterByType(typeId){
        $http.post(ApiEndpoint.url+"course/courseFilterByType.do",{},{params:{
            pageNum:1,
            pageSize:10,
            courseType : typeId
        }}).success(function(data){
    ...
    function courseFilterByPrice(priceId){
        $http.post(ApiEndpoint.url+"coure/courseFilterBtPrice.do",{},{params:{
            pageNum:1,
            pageSize:10,
            coursePrice : priceId
        }}).success(function(data){
...
.controller('ActiveCtrl',function($scope,$ionicLoading,$timeout,$ionicHistory,$state,$http,ApiEndpoint){
    ...
    $http.post(ApiEndpoint.url+"activity/getActivityList.do",{},{params:{
            pageNum:1,
            pageSize:10
        }}).success(function(data){
            // console.log(data);
...
.controller('MyselfCtrl',function($ionicActionSheet,$scope,$state,$http,$rootScope,ApiEndpoint,$location,$interval,$ionicPopup){
    ...
    $http.post(ApiEndpoint.url+"coupon/getUserCouponList.do",{},{params:{
        userId:localStorage.userId,
     }}).success(function(data){
        // console.log(data)
        if(data.errorCode == 0){
...
.controller('LoginCtrl',function($scope,$http,$timeout,$ionicLoading,$state,ApiEndpoint,PopService){
    ...
    // 短信登录
        ...
        $scope.getCode = function(){
            $http.post(ApiEndpoint.url+'user/genAuthCode.do',{},{params:{
        ...
        if(!$scope.user.mobile){
            ...
            PopService.showPop("验证码不能为空");
             ...
             if ($scope.code == undefined) {
                ...
                $http.post(ApiEndpoint.url+'user/messageLogin.do',{},{params:{
                    mobile:$scope.user.mobile,
    ...
    .controller('RegisterCtrl',function($scope,$http,$timeout,ApiEndpoint,$state,PopService){
        ...
        $scope.submit = function(){
            if(!$scope.registerData.mobile){
                ...
                $http.post(ApiEndpoint.url+'user/register.do',{},{params:{
                    mobile:$scope.registerData.mobile,
    ...
    .controller('MyActiveCtrl',function ($scope,$ionicHistory,$http,ApiEndpoint) {
        ...
        function price(){
            $http.post(ApiEndpoint.url+"activity/getMyActivityList.do",{},{params:{
                userId:localStorage.userId,
                 pageNum:1,
                 pageSize:10,
                 isAllStatus:0,
    ...
    .controller('MyCollectionCtrl',function ($scope,$ionicHistory,$http,ApiEndpoint) {
        ...
        function getcollect(){
            $http.post(ApiEndpoint.url+"collect/getMyCollect.do",{},{params:{
                userId:localStorage.userId,
                type:1,
                pageNum:1,
                pageSize:10
    ...
    .controller('MyConsumeRecordCtrl',function ($scope,$ionicHistory,$http,ApiEndpoint) {
        ...
        $http.post(ApiEndpoint.url+"record/getUserRecordList.do",{},{params:{
            userId:localStorage.userId,
            pageNum:1,
            pageSize:10
        }}).success(function(data){
                 ...
                 onTap: function(e) {
                    ...
                    xhr.onreadystatechange=function()
                      ...
                      if (xhr.readyState==4 && xhr.status==200)
                        {
                        $scope.showPop('上传成功');
                        $http.post(ApiEndpoint.url+"user/getUserByUserId.do",{},{params:{
   ...
   // 修改公司
    ...
    .controller('MyPrivateMessageCtrl',function ($scope,$ionicHistory,$http,ApiEndpoint) {
       ...
       $scope.noMorePage = false;
        ...
        function getMessage(){
            $http.post(ApiEndpoint.url+"message/getMessageList.do",{},{params:{
              userId:localStorage.userId,
                fromUserId:0,
    ...
    .controller('MyEditPasswordCtrl',function ($scope,$ionicHistory,$http,$state,ApiEndpoint,PopService) {
         ...
         $scope.keepinfo = function(){
            if(!$scope.registerData.password){
                ...
                $http.post(ApiEndpoint.url+"user/modifyPassword.do",{},{params:{
     ...
     .controller('UserFeedbackCtrl',function ($scope,$ionicHistory,$http,ApiEndpoint) {
        ...
        $scope.textChange = function() {
         ...
         $scope.keepinfo = function() {
            ...
            $http.post(ApiEndpoint.url+"feedback/addFeedback.do",{},{params:{
                userId:localStorage.userId,
...
.controller('AccountBindCtrl',function ($scope,$ionicHistory,$http,ApiEndpoint) {
    ...
    .controller('ActiveDetailsCtrl',function ($scope,$ionicHistory,$http,ApiEndpoint,$stateParams) {
        ...
        $http.post(ApiEndpoint.url+"activity/getActivityById.do",{},{params:{
